...
import bspsrc.*;
import bspsrc.modules.*;
import bspsrc.modules.texture.*;
import java.awt.*;
import java.io.*;
import java.net.*;
import java.nio.*;
...
public class BspInfoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        linkLabelAppURL = new util.gui.components.URILabel();
        ...
        checkBoxVmexEntity = new util.gui.components.ReadOnlyCheckBox();
        checkBoxVmexTexture = new util.gui.components.ReadOnlyCheckBox();
        checkBoxVmexBrush = new util.gui.components.ReadOnlyCheckBox();
        panelIID = new javax.swing.JPanel();
        checkBoxIIDObfs = new util.gui.components.ReadOnlyCheckBox();
        checkBoxIIDTexHack = new util.gui.components.ReadOnlyCheckBox();
        panelOther = new javax.swing.JPanel();
        checkBoxBSPProtect = new util.gui.components.ReadOnlyCheckBox();
    ...
    private util.gui.components.ReadOnlyCheckBox checkBoxBSPProtect;
    private util.gui.components.ReadOnlyCheckBox checkBoxIIDObfs;
    private util.gui.components.ReadOnlyCheckBox checkBoxIIDTexHack;
    private util.gui.components.ReadOnlyCheckBox checkBoxVmexBrush;
    private util.gui.components.ReadOnlyCheckBox checkBoxVmexEntity;
    private util.gui.components.ReadOnlyCheckBox checkBoxVmexTexture;
    ...
    private util.gui.components.URILabel linkLabelAppURL;
