...
public class BspInfoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        checkBoxVmexEntity = new ReadOnlyCheckBox();
        checkBoxVmexTexture = new ReadOnlyCheckBox();
        checkBoxVmexBrush = new ReadOnlyCheckBox();
        panelIID = new javax.swing.JPanel();
        checkBoxIIDObfs = new ReadOnlyCheckBox();
        checkBoxIIDTexHack = new ReadOnlyCheckBox();
        panelOther = new javax.swing.JPanel();
        checkBoxBSPProtect = new ReadOnlyCheckBox();
